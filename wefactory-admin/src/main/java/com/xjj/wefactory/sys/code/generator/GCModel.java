package com.xjj.wefactory.sys.code.generator;

import java.util.ArrayList;
import java.util.List;

import com.xjj.wefactory.sys.code.GCConfig;
...
public class GCModel {
	...
	public void setName() {
		...
		if(!StringUtils.isBlank(tablePre) && tName.startsWith(tablePre))
		{
			tName = tName.substring(tablePre.length());
		}
	...
	public boolean isHasBigDecimal(){
		for(ColumnInfo mf:fields){
			if(mf.getDataType().contains("decimal")){
				return true;
			}
		}
		return false;
